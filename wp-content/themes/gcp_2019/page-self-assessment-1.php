<?php
/**
 * Template Name: Self Assessment 1
 *
 */
...
<section class="landing-page-content">
  <div class="container">
    <div class="row">
      ...
      <div id="anchor" data-aos="fade-up" class="col-md-4 offset-md-1">
        <div class="new-form-wrapper">
          ...
          <img class="img-fluid" src="http://via.placeholder.com/450x350" alt="asd">
          <?php echo do_shortcode("[hubspot type=form portal=4643163 id=15a48524-9417-4dc0-82d8-6799361b0260]"); ?>
        </div>
      </div>
    </div>
  </div>
